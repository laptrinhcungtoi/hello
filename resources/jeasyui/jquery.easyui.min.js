...
(function($) {
    $.parser = {
        ...
        plugins: ["draggable", "droppable", "resizable", "pagination", "tooltip", "linkbutton", "menu", "menubutton", "splitbutton", "progressbar", "tree", "textbox", "filebox", "combo", "combobox", "combotree", "combogrids", "numberbox", "validatebox", "searchbox", "spinner", "numberspinner", "timespinner", "datetimespinner", "calendar", "datebox", "datetimebox", "slider", "layout", "panel", "datagrid", "propertygrid", "treegrid", "tabs", "accordion", "window", "dialog", "form"],
        parse: function(_2) {
            var aa = [];
...
(function($) {
    ...
    function load(_4c0, data) {
        ...
        function _4c6(name, val) {
            var form = $(_4c0);
            var cc = ["combobox", "combotree", "combogrids", "datetimebox", "datebox", "combo"];
    ...
    function _4c8(_4c9) {
        ...
        var t = $(_4c9);
        var _4cb = ["textbox", "combo", "combobox", "combotree", "combogrids", "slider"];
    ...
    function _4ce(_4cf) {
        _4cf.reset();
        var t = $(_4cf);
        var _4d0 = ["textbox", "combo", "combobox", "combotree", "combogrids", "datebox", "datetimebox", "spinner", "timespinner", "numberbox", "numberspinner", "slider"];
...
(function($) {
    ...
    var _6df = $.extend({}, _6d1(["text", "textbox", "numberbox", "numberspinner", "combobox", "combotree", "combogrids", "datebox", "datetimebox", "timespinner", "datetimespinner"]), {
        textarea: {
...
(function($) {
    function _985(_986) {
        var _987 = $.data(_986, "combogrids");
        var opts = _987.options;
        var grid = _987.grid;
        $(_986).addClass("combogrids-f").combo($.extend({}, opts, {
            onShowPanel: function() {
                var p = $(this).combogrids("panel");
                var _988 = p.outerHeight() - p.height();
                var _989 = p._size("minHeight");
                var _98a = p._size("maxHeight");
                $(this).combogrids("grid").datagrid("resize", {
                    width: "100%",
    ...
    function _9a3(_9a4) {
        ...
        $(_9a4).combogrids("setValues", vv);
        if (!opts.multiple) {
            $(_9a4).combogrids("hidePanel");
        }
    };
    $.fn.combogrids = function(_9a7, _9a8) {
        if (typeof _9a7 == "string") {
            var _9a9 = $.fn.combogrids.methods[_9a7];
            if (_9a9) {
        ...
        _9a7 = _9a7 || {};
        return this.each(function() {
            var _9aa = $.data(this, "combogrids");
            if (_9aa) {
                $.extend(_9aa.options, _9a7);
            } else {
                _9aa = $.data(this, "combogrids", {
                    options: $.extend({}, $.fn.combogrids.defaults, $.fn.combogrids.parseOptions(this), _9a7)
                });
            }
            _985(this);
        });
    };
    $.fn.combogrids.methods = {
        options: function(jq) {
            var _9ab = jq.combo("options");
            return $.extend($.data(jq[0], "combogrids").options, {
                width: _9ab.width,
                height: _9ab.height,
        ...
        grid: function(jq) {
            return $.data(jq[0], "combogrids").grid;
        },
        ...
        clear: function(jq) {
            return jq.each(function() {
                $(this).combogrids("grid").datagrid("clearSelections");
                $(this).combo("clear");
            });
        },
        reset: function(jq) {
            return jq.each(function() {
                var opts = $(this).combogrids("options");
                if (opts.multiple) {
                    $(this).combogrids("setValues", opts.originalValue);
                } else {
                    $(this).combogrids("setValue", opts.originalValue);
                }
            });
        }
    };
    $.fn.combogrids.parseOptions = function(_9ae) {
        var t = $(_9ae);
        return $.extend({}, $.fn.combo.parseOptions(_9ae), $.fn.datagrid.parseOptions(_9ae), $.parser.parseOptions(_9ae, ["idField", "textField", "mode"]));
    };
    $.fn.combogrids.defaults = $.extend({}, $.fn.combo.defaults, $.fn.datagrid.defaults, {
        height: 22,
        loadMsg: null,
        idField: null,
        textField: null,
